...
writeFileSync(
  ...
  [
    ...
    '',
    'This directory is the Node runtime the desktop app carries, plus the',
    'VibeTracker sources. Do not edit it by hand; it is regenerated on every',
    'build by scripts/desktop-stage.mjs.',
    '',
    'Licence: Apache-2.0 (see LICENSE). Node.js comes under its own licence.',
    '',
  ].join('\n'),
  'utf8',
);
